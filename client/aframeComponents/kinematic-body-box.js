...
AFRAME.registerComponent('kinematic-body', {
  ...
  init: function () {
    ...
    if(geo.primitive === 'box') {
      data.boxDimensions = [geo.width, geo.height, geo.depth];
    }

    this.body = new CANNON.Body({
      shape: new CANNON.Box(new CANNON.Vec3(...data.boxDimensions)),
